  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
    ...
    <script>
    	...
    	$(document).ready(function() {
    		$.ajax({
    			url: "http://localhost:8090/mgb/user/tour/ajax/starHigh",
    			method: "GET",
    		...
    		$("li[data-value='costHigh']").click(function() {
    			$.ajax({
        			url: "http://localhost:8090/mgb/user/tour/ajax/costHigh",
        			method: "GET",
        			success: function(data) {
        				var row = "<div class='row'>";
        				for (i = 0; i < data.length; i++) {
    		...
    		$("li[data-value='costLow']").click(function() {
    			$.ajax({
        			url: "http://localhost:8090/mgb/user/tour/ajax/costLow",
        			method: "GET",
        			success: function(data) {
        				var row = "<div class='row'>";
        				for (i = 0; i < data.length; i++) {
