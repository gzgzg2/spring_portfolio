...
<body>
    ...
    <section class="aboutus-page-section spad">
	    <div class="s003">
	      <form action="${pageContext.request.contextPath }/user/inn/list/search" method="get" onsubmit="return chkSubmit()">
	        <div class="inner-form">
	          ...
	          <div class="input-field second-wrap">
	            <input id="search" name="searchKeyword" type="text" value="${inn_name }" placeholder="전체 검색은 공백을 입력하세요" />
	          </div>
    	...
    	$(document).ready(function() {
    		...
    		$("#search").autocomplete({
                source : function( request, response ) {
                     $.ajax({
                            type: 'get',
                            url: "http://localhost:8090/mgb/user/inn/ajax/" + ajaxOption + "/" + ajaxKeyword,
                            dataType: "json",
