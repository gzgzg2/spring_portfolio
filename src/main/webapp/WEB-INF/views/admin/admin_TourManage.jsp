...
function loadPage(page){
	...
	$.ajax({
		url : "${pageContext.request.contextPath}/AdminBookAJAX/admin_TourManage/<%=writePages%>/"+ page,
					type : "GET",
					cache : false,
	...
	function search(search_page){
		...
		// AJAX
		$.ajax({
			url : "${pageContext.request.contextPath}/AdminBookAJAX/admin_TourManage/" + search_option + "/" + keyword + "/<%=writePages%>/"+search_page,
			type : "GET",
			cache : false,
			success : function(data, status){
				if(status == "success"){
								...
								<ul class="vertical-nav-menu">
									...
									<li class="menu">
										...
										<ul>
											...
											<li>
												<a href="admin_TourManage" class="mm-active">투어 예약관리</a>
											</li>
											<li>
